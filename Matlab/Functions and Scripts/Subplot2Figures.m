% CLOSE ALL FIGURES BEFORE RUNNING - opens two figures and puts them in a subplot together.
h1 = openfig('phnum.fig','reuse'); % open figure
ax1 = gca; % get handle to axes of figure
h2 = openfig('purity.fig','reuse');
ax2 = gca;
