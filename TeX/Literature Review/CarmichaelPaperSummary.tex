...
\begin{figure}[h]
 ...
 \caption{Comparison of mean field and fully quantum contour plots with critical points at $\frac{\Epsilon}{2}$ highlighted}
 \end{figure}
...
\begin{figure}[h]
 \begin{minipage}{.5\linewidth}
  ...
  \subcaption{Q functions moving through the critical point at $\frac{\Epsilon}{2}$}
  \end{minipage}%
  \begin{minipage}{.5\linewidth}
      \centering
      \includegraphics[width=1\textwidth]{Images/Q-Bistability.png}
      \subcaption{Q functions moving onto the walls of the lorentzian}
  \end{minipage}
  \caption{Q-bistabilities}
\end{figure}
