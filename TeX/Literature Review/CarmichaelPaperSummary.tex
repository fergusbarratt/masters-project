...
\begin{figure}[H]
 	...
 	\caption{Non-exponential decay of $\zeta$, $\frac{g}{\kappa} = 50, \zeta(0) = 0$} \label{fig:neoclassical}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{minipage}{.5\linewidth}
		...
		\subcaption{$\beta$ with increasing drive greater than critical}
		\label{fig:alpha}
	\end{minipage}
	\caption{$\alpha$ and $\zeta$ as the drive strength $\Epsilon$ moves up to through and beyond the critical point}
\end{figure}
in \cref{fig:alpha} the phase bistability above the critical point is obvious. The two $\alpha$ solution branches start coincident ($\pi$ and $-\pi$) at drive strengths just above critical and quickly move to opposite sides of the Bloch sphere ($-\frac{\pi}{2}$ and $\frac{\pi}{2}$)
...
\begin{align}
	...
	\beta& = \pm sgn(\Delta \omega) \frac{g |\alpha|}{\sqrt{\Delta \omega^2 + g^2 |\qexp{\ann|}|^2}}\\
