...
% \usepackage{fullpage}
\usepackage{graphicx}
\usepackage[backend=biber, ordering=none, style=phys]{biblatex}
...
\part{Introduction}
\section{Outline}
  % In this project we investigate the behaviour of the Jaynes-Cummings system \cite{Jaynes1963a}, in the presence of dissipation of various forms, and under the influence of a coherent drive. We reproduce a large number of the results of papers Carmichael, Alsing and Savage \cite{Carmichael2015} \cite{Savage1988} \cite{Alsing1990}
\part{Thesis}
\section{The Statistical Interpretation of Quantum Mechanics\autocite{Breuer2002}}
