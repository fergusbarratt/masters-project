...
\end{frame}
\begin{frame}
    \includegraphics[width=\linewidth, height=\textheight, keepaspectratio]{resonant.pdf}
\end{frame}
\begin{frame}
...
\end{frame}
\begin{frame}
    \includegraphics[width=\linewidth, height=\textheight, keepaspectratio]{dispersive.pdf}
\end{frame}
\printbibliography\
\end{document}
